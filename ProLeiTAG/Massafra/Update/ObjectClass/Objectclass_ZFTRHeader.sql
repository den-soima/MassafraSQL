...
------------------------------------------------------------------------------------
--
DECLARE @ClassName NVARCHAR(255) = N'ZFTRHeader'
-- 
PRINT '-----------------------------------------------------------------------------'
...
EXEC ydm.spObjectClassProvideByName
            @Name                      = @ClassName
          , @ObjectClassLocalName      = N'FTR Header'
          , @ObjectClassGlobalName     = N'FTR Header'
          , @SchemaName                = N'Ods'
          , @TableName                 = @ClassName    
          , @KeyRangeStart             = 990000700000000
...
EXEC ydm.spObjectClassPropertyProvideByName  
		  ...
		  , @ObjectClassPropertyLocalName  = N'CreatedUser'
		  , @ObjectClassPropertyGlobalName = N'CreatedUser'
...
EXEC ydm.spObjectClassPropertyProvideByName  
		  ...
		  , @DataKind					   = N'[DataKind character string]'		
		  , @ObjectClassPropertyLocalName  = N'InsertID'
		  , @ObjectClassPropertyGlobalName = N'InsertID'
