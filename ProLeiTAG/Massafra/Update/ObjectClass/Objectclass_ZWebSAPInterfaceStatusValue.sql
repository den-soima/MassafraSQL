...
------------------------------------------------------------------------------------
--
DECLARE @ClassName NVARCHAR(255) = N'ZWebSAPInterfaceStatusValue'
-- 
PRINT '-----------------------------------------------------------------------------'
...
EXEC ydm.spObjectClassProvideByName
            @Name                      = @ClassName
          , @ObjectClassLocalName      = N'Web SAP Interface Status Value (View)'
          , @ObjectClassGlobalName     = N'Web SAP Interface Status Value (View)'
          , @SchemaName                = N'Ods'
          , @TableName                 = @ClassName    
          , @KeyRangeStart             = 990000100000000
...
EXEC ydm.spObjectClassPropertyProvideByName
         @ObjectClassLink                = @ClassName
        , @ColumnName					   = N'DTORecordingTime'
        , @DataKind					   = N'[DataKind datetimeoffset]'
        , @ObjectClassPropertyLocalName  = N'DTORecordingTime'
        , @ObjectClassPropertyGlobalName = N'DTORecordingTime'
        , @ModelConventions              = N'{"PropertyName": "DTORecordingTime"}'
        , @DataCompute				   = N''
        , @AllowNull					   = 1
        , @NoXU						   = 1
        , @ErrorNumber =  @ErrorNumber OUTPUT, @ErrorText = @ErrorText OUTPUT
...
EXEC ydm.spObjectClassPropertyProvideByName  
		  ...
		  , @DataCompute				   = N'cast(DTORecordingTime as datetime) persisted'
		  , @AllowNull					   = 1
		  , @NoXU						   = 1
		  , @ErrorNumber =  @ErrorNumber OUTPUT, @ErrorText = @ErrorText OUTPUT
          , @Debug = @Debug
...
EXEC ydm.spObjectClassProvideSuperOrdinatedObjectAttributeByName
            @ObjectClassLink     = @ClassName
		  , @ColumnNameStub      = N''
          , @ModelConventions    = N'{"PropertyName": "_EnumerationLink" , "NavigationPropertyName": "Enumeration", "NavigationInversePropertyName": "ZWebSAPInterfaceStatusValue"}'
          , @GeneratorFlags      = 2
