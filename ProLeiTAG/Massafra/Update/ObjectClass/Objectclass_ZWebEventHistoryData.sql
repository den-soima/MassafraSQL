...
------------------------------------------------------------------------------------
--
DECLARE @ClassName NVARCHAR(255) = N'ZWebEventHistoryData'
-- 
PRINT '-----------------------------------------------------------------------------'
...
EXEC ydm.spObjectClassProvideByName
            @Name                      = @ClassName
          , @ObjectClassLocalName      = N'Web Event History Data'
          , @ObjectClassGlobalName     = N'Web Event History Data'
          , @SchemaName                = N'Ods'
          , @TableName                 = @ClassName    
          , @KeyRangeStart             = 990001300000000
...
EXEC ydm.spObjectClassPropertyProvideByName
            @ObjectClassLink               = @ClassName
          , @ColumnName					   = N'_ZTemplateKey'
          , @DataKind					   = N'[DataKind integer]'
          , @ObjectClassPropertyLocalName  = N'_ZTemplateKey'
          , @ObjectClassPropertyGlobalName = N'_ZTemplateKey'
          , @ModelConventions              = N'{"PropertyName": "_ZTemplateKey"}'
          , @DataCompute				   = N''
          , @AllowNull					   = 1
          , @NoXU						   = 1
          , @ErrorNumber =  @ErrorNumber OUTPUT, @ErrorText = @ErrorText OUTPUT
