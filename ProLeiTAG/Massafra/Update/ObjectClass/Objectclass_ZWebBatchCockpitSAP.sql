...
------------------------------------------------------------------------------------
--
DECLARE @ClassName NVARCHAR(255) = N'ZWebBatchCockpitSAP'
-- 
PRINT '-----------------------------------------------------------------------------'
...
EXEC ydm.spObjectClassProvideByName
            @Name                      = @ClassName
          , @ObjectClassLocalName      = N'Web Batch Cockpit SAP'
          , @ObjectClassGlobalName     = N'Web Batch Cockpit SAP'
          , @SchemaName                = N'Ods'
          , @TableName                 = @ClassName    
          , @KeyRangeStart             = 990009900000000
...
EXEC ydm.spObjectClassPropertyProvideByName
            @ObjectClassLink               = @ClassName
          , @ColumnName					   = N'OpeningStock'
          , @DataKind					   = N'[DataKind floating point number]'
          , @ObjectClassPropertyLocalName  = N'OpeningStock'
          , @ObjectClassPropertyGlobalName = N'OpeningStock'
          , @ModelConventions              = N'{"PropertyName": "OpeningStock"}'
          , @DataCompute				   = N''
          , @AllowNull					   = 0
          , @NoXU						   = 0
          , @ErrorNumber =  @ErrorNumber OUTPUT, @ErrorText = @ErrorText OUTPUT
...
EXEC ydm.spObjectClassPropertyProvideByName  
			@ObjectClassLink               = @ClassName
		  , @ColumnName					   = N'StatePO'
		  , @DataKind					   = N'[DataKind integer]'
          , @DataDefault                   = N'0'
		  , @ObjectClassPropertyLocalName  = N'StatePO'
		  , @ObjectClassPropertyGlobalName = N'StatePO'
		  , @ModelConventions              = N'{"PropertyName": "Created"}'
		  , @DataCompute				   = N''
		  , @AllowNull					   = 1
		  , @NoXU						   = 1
...
EXEC ydm.spObjectClassPropertyProvideByName  
			@ObjectClassLink               = @ClassName
		  , @ColumnName					   = N'StatePP'
		  , @DataKind					   = N'[DataKind integer]'
          , @DataDefault                   = N'0'
		  , @ObjectClassPropertyLocalName  = N'StatePP'
		  , @ObjectClassPropertyGlobalName = N'StatePP'
		  , @ModelConventions              = N'{"PropertyName": "StatePP"}'
		  , @DataCompute				   = N''
		  , @AllowNull					   = 1
		  , @NoXU						   = 1
		  , @ErrorNumber =  @ErrorNumber OUTPUT, @ErrorText = @ErrorText OUTPUT
...
EXEC ydm.spObjectClassPropertyProvideByName  
			@ObjectClassLink               = @ClassName
		  , @ColumnName					   = N'StateTankBatch'
		  , @DataKind					   = N'[DataKind integer]'
          , @DataDefault                   = N'0'
		  , @ObjectClassPropertyLocalName  = N'StateTankBatch'
		  , @ObjectClassPropertyGlobalName = N'StateTankBatch'
		  , @ModelConventions              = N'{"PropertyName": "StateTankBatch"}'
		  , @DataCompute				   = N''
		  , @AllowNull					   = 1
		  , @NoXU						   = 1
		  , @ErrorNumber =  @ErrorNumber OUTPUT, @ErrorText = @ErrorText OUTPUT
