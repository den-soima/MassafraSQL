...
------------------------------------------------------------------------------------
--
DECLARE @ClassName NVARCHAR(255) = N'ZWebTestConformance'
-- 
PRINT '-----------------------------------------------------------------------------'
...
EXEC ydm.spObjectClassProvideByName
            @Name                      = @ClassName
          , @ObjectClassLocalName      = N'Web Test Conformance'
          , @ObjectClassGlobalName     = N'Web Test Conformance'
          , @SchemaName                = N'Ods'
          , @TableName                 = @ClassName    
          , @KeyRangeStart             = 990001600000000
