...
------------------------------------------------------------------------------------
--
DECLARE @ClassName NVARCHAR(255) = N'ZWebVariableConformance'
-- 
PRINT '-----------------------------------------------------------------------------'
...
EXEC ydm.spObjectClassProvideByName
            @Name                      = @ClassName
          , @ObjectClassLocalName      = N'Web Variable Conformance'
          , @ObjectClassGlobalName     = N'Web Variable Conformance'
          , @SchemaName                = N'Ods'
          , @TableName                 = @ClassName    
          , @KeyRangeStart             = 990001700000000
...
EXEC ydm.spObjectClassProvideSuperOrdinatedObjectAttributeByName
            @ObjectClassLink     = @ClassName
		  , @ColumnNameStub      = N''
          , @ModelConventions    = N'{"PropertyName": "_EnumerationLink" , "NavigationPropertyName": "Enumeration", "NavigationInversePropertyName": "ZWebVariableConformance"}'
		  , @GeneratorFlags      = 2
